...
public interface RecordCollectionWorkMapper extends BaseMapper<RecordCollectionWork> {
    ...
    @Select("select w.work_id, w.tags, w.work_name, w.author, w.introduction, w.publisher,w.sum_rating, w.sum_rating_user_number, w.cover_link, rcw.create_time, rcw.update_time " +
            "from work w join record_collection_work rcw on w.work_id = rcw.work_id where rcw.collection_id = ${collectionId} order by rcw.update_time desc ")
