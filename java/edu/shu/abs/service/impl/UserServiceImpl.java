...
public class UserServiceImpl extends BaseServiceImpl<UserMapper, User> implements UserService {
    ...
    public String login(UserLoginVo userLoginVo) {
        ...
        UserInfo.set(user.getUserId(), user.getRole(), token);
        return token;
    }
    ...
    public UserInfoVo info(String token) {
        ...
        userInfoVo.setRoles(Arrays.asList(user.getRole().getValue()));    // 将role属性从Role转到List<String>
        return userInfoVo;
    }
    ...
    public UserInfoVo getOtherUserInfo(Long userId) {
        ...
        UserInfoVo userInfoVo = new UserInfoVo();
        BeanUtils.copyProperties(user, userInfoVo);     // 将user的属性赋值给vo
        userInfoVo.setRoles(Arrays.asList(user.getRole().getValue()));    // 将role属性从int转到List<String>
        return userInfoVo;
    }
