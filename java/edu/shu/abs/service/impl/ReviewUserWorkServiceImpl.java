...
public class ReviewUserWorkServiceImpl extends BaseServiceImpl<ReviewUserWorkMapper, ReviewUserWork> implements ReviewUserWorkService {
    ...
    @Override
    public IPage<ReviewUserWorkWithWorkVo> getAllPageReview(int currentPage, int pageSize) {
        return reviewUserWorkMapper.selectReviewUserWorkWithWorkAll(new Page<>(currentPage, pageSize));
    }
    
    @Override
    public List<ReviewUserWorkWithWorkVo> getMyAllCollectionWithCheckingWork() {
        Long userId = UserInfo.getUserId();
        return reviewUserWorkMapper.selectAllReviewUserWorkWithWork(userId);
    }
